...
<<<<<<< HEAD
	FFO_CONTRACT []string  `protobuf:"bytes,1,rep,name=FFO_CONTRACT,json=FFOCONTRACT,proto3" json:"FFO_CONTRACT,omitempty"`
	FFO_PSTN     []string  `protobuf:"bytes,2,rep,name=FFO_PSTN,json=FFOPSTN,proto3" json:"FFO_PSTN,omitempty"`
	FFO_QTY      []int32   `protobuf:"varint,3,rep,packed,name=FFO_QTY,json=FFOQTY,proto3" json:"FFO_QTY,omitempty"`
	FFO_AVG_PRC  []float32 `protobuf:"fixed32,4,rep,packed,name=FFO_AVG_PRC,json=FFOAVGPRC,proto3" json:"FFO_AVG_PRC,omitempty"`
	// ver 1.1  Models Updated
	FCP_XCHNG_CD []string `protobuf:"bytes,5,rep,name=FCP_XCHNG_CD,json=FCPXCHNGCD,proto3" json:"FCP_XCHNG_CD,omitempty"`
	FCP_IBUY_QTY []int32  `protobuf:"varint,6,rep,packed,name=FCP_IBUY_QTY,json=FCPIBUYQTY,proto3" json:"FCP_IBUY_QTY,omitempty"`
	// Client mtch account
	...
	FCP_PRDCT_TYP      []string  `protobuf:"bytes,8,rep,name=FCP_PRDCT_TYP,json=FCPPRDCTTYP,proto3" json:"FCP_PRDCT_TYP,omitempty"`
	FCP_INDSTK         []string  `protobuf:"bytes,9,rep,name=FCP_INDSTK,json=FCPINDSTK,proto3" json:"FCP_INDSTK,omitempty"`
	FCP_UNDRLYNG       []string  `protobuf:"bytes,10,rep,name=FCP_UNDRLYNG,json=FCPUNDRLYNG,proto3" json:"FCP_UNDRLYNG,omitempty"`
	FCP_EXPRY_DT       []string  `protobuf:"bytes,11,rep,name=FCP_EXPRY_DT,json=FCPEXPRYDT,proto3" json:"FCP_EXPRY_DT,omitempty"`
	FCP_EXER_TYP       []string  `protobuf:"bytes,12,rep,name=FCP_EXER_TYP,json=FCPEXERTYP,proto3" json:"FCP_EXER_TYP,omitempty"`
	FCP_OPT_TYP        []string  `protobuf:"bytes,13,rep,name=FCP_OPT_TYP,json=FCPOPTTYP,proto3" json:"FCP_OPT_TYP,omitempty"`
	FCP_STRK_PRC       []float32 `protobuf:"fixed32,14,rep,packed,name=FCP_STRK_PRC,json=FCPSTRKPRC,proto3" json:"FCP_STRK_PRC,omitempty"`
	// UCC ID
	FCP_UCC_CD string `protobuf:"bytes,15,opt,name=FCP_UCC_CD,json=FCPUCCCD,proto3" json:"FCP_UCC_CD,omitempty"`
	// Open_Pstn_Flow added
	FCP_OPNPSTN_FLW []string `protobuf:"bytes,16,rep,name=FCP_OPNPSTN_FLW,json=FCPOPNPSTNFLW,proto3" json:"FCP_OPNPSTN_FLW,omitempty"`
}
...
func (x *FnoPositionResponse) GetFFO_CONTRACT() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFFO_PSTN() []string {
	if x != nil {
		return x.FFO_PSTN
	}
	return nil
...
func (x *FnoPositionResponse) GetFFO_QTY() []int32 {
	if x != nil {
		return x.FFO_QTY
	}
	return nil
...
func (x *FnoPositionResponse) GetFFO_AVG_PRC() []float32 {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_XCHNG_CD() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_IBUY_QTY() []int32 {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_CLM_MTCH_ACCNT() string {
=======
...
<<<<<<< HEAD
func (x *FnoPositionResponse) GetFCP_PRDCT_TYP() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_INDSTK() []string {
	if x != nil {
		return x.FCP_INDSTK
	}
	return nil
...
func (x *FnoPositionResponse) GetFCP_UNDRLYNG() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_EXPRY_DT() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_EXER_TYP() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_OPT_TYP() []string {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_STRK_PRC() []float32 {
	if x != nil {
...
func (x *FnoPositionResponse) GetFCP_UCC_CD() string {
=======
...
<<<<<<< HEAD
func (x *FnoPositionResponse) GetFCP_OPNPSTN_FLW() []string {
	if x != nil {
...
<<<<<<< HEAD
	,
